...
public class LastName_check extends BaseTest {
    ...
    public void checkNameField_positive(String value, boolean isPresentExpected) throws InterruptedException {
        registrationPage = EnterValue_toField.enterValue_toField(value, registrationPage.getRegisterLastName(), registrationPage);
        Thread.sleep(100);
        boolean isPresentActual= isPresentForWait(registrationPage.getInvalidRegisterLastName());
    ...
    public void checkNameField_negative(String value, boolean isPresentExpected, String  sort_of_check) throws InterruptedException {
        ...
        if(isPresentActual) {
            ...
            try {
                ...
                nametext = registrationPage.getLastNameTitleText().getAttribute("data-label");
