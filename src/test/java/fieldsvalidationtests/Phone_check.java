...
public class Phone_check  extends BaseTest {
    ...
    public Object[][] testData_positive() {
        return new Object[][]{{"+380935478741", true},{"0935464585", true},{"5441414", true}};
    }
    @DataProvider(name = "check_Name_field_negative")
    public Object[][] testData_negative() {
        return new Object[][]{{"h", false, "length<2"},{"Aa!@#$%^&*()-_+=`~/\\,.?><|b /ыйієж", false, "special character"},{ new GenerationField().generateField(100), false, "length100"},{"検査検査検査", false,"japanese"},{"فحصفحصفحصفحص", false,"arabic"} ,{"a12_def12123",false,"character and numeric"}};
    }
    ...
    public void checkNameField_positive(String value, boolean isPresentExpected) throws InterruptedException {
        registrationPage = EnterValue_toField.enterValue_toField(value, registrationPage.getPhoneNumber(), registrationPage);
        Thread.sleep(100);
        boolean isPresentActual= isPresentForWait(registrationPage.getInvalidRegisterPhone());
    ...
    public void checkNameField_negative(String value, boolean isPresentExpected, String  sort_of_check) throws InterruptedException {
        ...
        if(isPresentActual) {
            ...
            try {
                ...
                nametext = registrationPage.getPhoneNameTitleText().getAttribute("data-label");
