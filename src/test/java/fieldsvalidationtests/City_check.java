...
public class City_check extends BaseTest {
    ...
    public Object[][] testData_positive() {
        return new Object[][]{{"Lviv", true},{"abc_12_def", true}};
    }
    ...
    public void checkNameField_positive(String value, boolean isPresentExpected) throws InterruptedException {
        registrationPage = EnterValue_toField.enterValue_toField(value, registrationPage.getRegisterCity(), registrationPage);
        Thread.sleep(100);
        boolean isPresentActual= isPresentForWait(registrationPage.getInvalidRegisterCity());
    ...
    public void checkNameField_negative(String value, boolean isPresentExpected, String  sort_of_check) throws InterruptedException {
        ...
        if(isPresentActual) {
            ...
            try {
                String errormessage = driver.findElement(By.xpath("//span[@class='requiredField']")).getText();
                System.out.println("2errormessage " +errormessage+ " , value: "+ value);
                nametext = registrationPage.getCityNameTitleText().getAttribute("data-label");
